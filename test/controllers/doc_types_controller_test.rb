...
class DocTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doc_type" do
    assert_difference('DocType.count') do
      post doc_types_url, params: { doc_type: { shortname: @doc_type.shortname, template: @doc_type.template, title: @doc_type.title } }
    end
  ...
  test "should update doc_type" do
    patch doc_type_url(@doc_type), params: { doc_type: { shortname: @doc_type.shortname, template: @doc_type.template, title: @doc_type.title } }
